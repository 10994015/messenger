<div class="wsus__user_list">
    ...
    <div class="wsus__favourite_user">
        ...
        <div class="row favourite_user_slider">
            ...
            <div class="col-xl-3 messenger_list_item" data-id="{{ $item->user?->id }}">
                <a href="#" class="wsus__favourite_item">
                    <div class="img">
                        <img src="{{ asset($item->user?->avatar) }}" alt="{{ $item->user?->name }}" class="img-fluid">
    ...
    <div class="wsus__save_message">
        ...
        <div class="wsus__save_message_center messenger_list_item" data-id="{{ auth()->id() }}">
            <div class="icon">
