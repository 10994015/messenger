...
<section class="wsus__chat_app show_info">
    ...
    <div class="wsus__chat_area">
        ...
        <div class="wsus__message_paceholder block d-flex justify-content-center align-items-center">
            <span class="select_a_user">Select a user for start conversation.</span>
        </div>
        ...
        <div class="wsus__chat_area_footer">
            <div class="footer_message">
                <div class="img d-none attachment-block">
                    <img src="" alt="" class="img-fluid attachment-preview">
